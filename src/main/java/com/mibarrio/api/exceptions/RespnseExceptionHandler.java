...
@RestController
@ControllerAdvice
public class RespnseExceptionHandler extends ResponseEntityExceptionHandler {

    @ExceptionHandler(ModeloNotFoundExeption.class)
    public ResponseEntity<ExceptionResponse> handleModeloNotFoundExeption(ModeloNotFoundExeption ex, WebRequest request){
